...
const createReview = async (payload) => {
    ...
    if (!studentId || !tutorProfileId || !rating) {
        throw new AppError(httpStatus.BAD_REQUEST, "bookingId, studentId, tutorProfileId, and rating are required");
    }
    // Validate rating
    ...
    if (!booking) {
        throw new AppError(httpStatus.NOT_FOUND, "You've not made a booking with this tutor");
    }
    ...
    if (existingReview) {
        throw new AppError(httpStatus.CONFLICT, "You've already reviewed this tutor");
    }
    // Create review
